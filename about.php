                ...
                <div class="col-8 col-sm-4">
                    <div class="form-box">
                        <form method="POST" action="">
                            <fieldset>
                                <button class="btn btn-primary d-block w-100" type="submit" name="submitlogout">
                                <a href="about.php?logout=true" style="color : #fff;" >Log Out</a>
                                </button>
                            </fieldset>
                        </form>
                    </div>
